    ...
    <main className="min-h-screen bg-slate-50 pt-20">
      ...
      <section className="relative h-[400px] md:h-[500px] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <Link href="/#services" className="inline-flex items-center text-white/90 hover:text-white mb-8 transition-colors font-medium bg-black/20 hover:bg-black/40 px-4 py-2 rounded-full backdrop-blur-sm border border-white/10 w-fit">
            <ArrowLeft className="w-4 h-4 mr-2" />
            Voltar para Serviços
          </Link>
          
          <div className="flex items-center space-x-4 mb-6">
            <div className="bg-brand-accent p-3 rounded-xl text-white [&>svg]:w-8 [&>svg]:h-8 shrink-0 shadow-lg shadow-brand-accent/30">
              {service.icon}
            </div>
          ...
          <p className="text-xl md:text-2xl text-blue-50 max-w-3xl mt-4 leading-relaxed font-light">
            {service.shortDesc}
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16">
            ...
            <div className="lg:col-span-2">
              <h2 className="text-3xl md:text-4xl font-bold text-brand-blue mb-8 leading-tight">
